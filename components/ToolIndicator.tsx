...
const LABELS: Record<ToolName, string> = {
  ...
  resize_room: "Redimensionando cômodo",
  duplicate_room: "Duplicando cômodo",
  add_door: "Posicionando porta",
  add_window: "Abrindo janela",
  delete_wall: "Removendo parede",
  merge_rooms: "Fundindo cômodos",
  add_partition: "Adicionando divisória",
  split_room: "Dividindo cômodo",
  move_wall: "Movendo parede",
  add_column: "Posicionando coluna",
  add_furniture: "Posicionando móvel",
  add_furniture_group: "Mobiliando conjunto",
  swap_furniture: "Trocando móvel",
  remove_furniture: "Retirando móvel",
  move_furniture: "Reposicionando móvel",
  set_floor_material: "Trocando piso",
  split_floor: "Dividindo piso",
  mirror_layout: "Espelhando planta",
  rotate_layout: "Girando planta",
  add_balcony: "Criando varanda",
  add_stairs: "Posicionando escada",
  add_dimension: "Adicionando cota",
  add_text_note: "Adicionando nota",
  add_north_arrow: "Adicionando rosa-dos-ventos",
